...
exports.default = _react2.default.createClass({
  ...
  render: function render() {
    return _react2.default.createElement(
      'form',
      { onSubmit: this.addCategory, ref: 'frmCategory' },
      _react2.default.createElement('input', { type: 'text', ref: 'categoryName' }),
      _react2.default.createElement('input', { type: 'submit', defaultValue: 'Add' })
    );
  }
});

},{"react":166,"uuid-lib":167}],2:[function(require,module,exports){
'use strict';
...
var _categoryAddForm = require('./category-add-form');

var _categoryAddForm2 = _interopRequireDefault(_categoryAddForm);
...
var componentTitle = 'Category';

exports.default = _react2.default.createClass({
  displayName: 'category',
  handleClick: function handleClick(obj) {
    var item = this.refs[obj.id],
        parentList = item.parentNode,
        parentListItems = parentList.querySelectorAll('.list__item');

    // remove any selected class
    _helpers2.default.removeClass(parentListItems, 'list__item--selected');
    // add selected class to this item
    item.classList.add('list__item--selected');
    this.props.selectCategory(obj);
  },
  renderCategories: function renderCategories(obj) {
    return _react2.default.createElement('li', { key: obj.id, className: 'list__item', ref: obj.id, onClick: this.handleClick.bind(this, obj) }, _react2.default.createElement('span', null, obj.category));
  },
  render: function render() {
    var categories = this.props.categories;

    categories.sort(_helpers2.default.sortAlphaObj.bind(this, 'category'));

    return _react2.default.createElement('section', { className: 'grid-4' }, _react2.default.createElement('h1', null, ' ', componentTitle, ' '), _react2.default.createElement(_categoryAddForm2.default, this.props), _react2.default.createElement('ul', { className: 'list list--categories' }, categories.map(this.renderCategories)));
  }
});

},{"../helpers":4,"./category-add-form":1,"react":166}],3:[function(require,module,exports){
'use strict';
...
var componentTitle = 'testing';

exports.default = _react2.default.createClass({
  displayName: 'cause',
  render: function render() {
    return _react2.default.createElement('section', { className: 'grid-4' }, _react2.default.createElement('h1', null, ' ', componentTitle, ' '), _react2.default.createElement('span', null, ' Select a Sub-Category '));
  }
});
...
///
var helpers = {
  sortAlpha: function sortAlpha(a, b) {
    if (a < b) {
      return -1;
    }
  ...
  sortAlphaObj: function sortAlphaObj(prop, a, b) {
    var sortA = a[prop].toLowerCase(),
  ...
  setLocalStore: function setLocalStore(key, value) {
    if (key != null) {
      if (value == null) {
  ...
  getLocalStore: function getLocalStore(key) {
    if (key == null) {
      return null;
    }
...
var _subCategory = require('./sub-category/sub-category');

var _subCategory2 = _interopRequireDefault(_subCategory);

var _cause = require('./cause/cause');
...
var App = _react2.default.createClass({
  ...
  getInitialState: function getInitialState() {
    var categories = JSON.parse(_helpers2.default.getLocalStore('categories')) || [],
        subCategories = JSON.parse(_helpers2.default.getLocalStore('subCategories')) || [];
  ...
  addCategory: function addCategory(category) {
    ...
    _helpers2.default.setLocalStore('categories', JSON.stringify(categories));
  },
  selectCategory: function selectCategory(obj) {
    var selectedCategory = this.state.selectedCategory;
    selectedCategory = obj;

    this.setState({ selectedCategory: selectedCategory });
  },
  addSubCategory: function addSubCategory(subCategory) {
    var subCategories = this.state.subCategories.slice();
    subCategories.push(subCategory);

    this.setState({ subCategories: subCategories });

    _helpers2.default.setLocalStore('subCategories', JSON.stringify(subCategories));
  },
  render: function render() {
    ...
    return _react2.default.createElement('div', { className: 'container' }, _react2.default.createElement(_category2.default, { categories: categories, addCategory: this.addCategory, selectCategory: this.selectCategory }), _react2.default.createElement(_subCategory2.default, { subCategories: subCategories, selectedCategory: selectedCategory, addSubCategory: this.addSubCategory }), _react2.default.createElement(_cause2.default, null));
  }
});
...
},{"./category/category":2,"./cause/cause":3,"./helpers":4,"./sub-category/sub-category":8,"react":166,"react-dom":10}],6:[function(require,module,exports){
"use strict";
...
exports.default = _react2.default.createClass({
  ...
  render: function render() {
    var selectedCategory = this.props.selected;

    return _react2.default.createElement("div", { className: "selected-item" }, "Selected: ", selectedCategory.category, _react2.default.createElement("span", { className: "selected-item__cancel" }, "x"));
  }
});
...
exports.default = _react2.default.createClass({
  displayName: 'sub-category-add-form',
  addSubCategory: function addSubCategory(e) {
    e.preventDefault();
  ...
  render: function render() {
    return _react2.default.createElement('form', { onSubmit: this.addSubCategory, ref: 'frmSubCategory' }, _react2.default.createElement('input', { type: 'text', ref: 'categoryName' }), _react2.default.createElement('input', { type: 'submit', defaultValue: 'Add' }));
  }
});

},{"react":166,"uuid-lib":167}],8:[function(require,module,exports){
'use strict';
...
var _selectedCategory = require('./selected-category');

var _selectedCategory2 = _interopRequireDefault(_selectedCategory);

var _subCategoryAddForm = require('./sub-category-add-form');

var _subCategoryAddForm2 = _interopRequireDefault(_subCategoryAddForm);
...
exports.default = _react2.default.createClass({
  ...
  noCategorySelectedHtml: function noCategorySelectedHtml() {
    return _react2.default.createElement('span', null, ' Select a Category ');
  },
  noSubCategories: function noSubCategories() {
    return _react2.default.createElement('span', null, ' No Sub-Categories added ');
  },
  renderSubCategories: function renderSubCategories(obj) {
    return _react2.default.createElement('li', { key: obj.id, className: 'list__item', ref: obj.id, onClick: this.handleClick.bind(this, obj) }, _react2.default.createElement('span', null, obj.subCategory));
  },
  ...
  render: function render() {
    var categories = this.props.categories,
        ...
        filteredSubCategories = subCategories.filter(function (obj) {
      return hasSelectedCategory ? obj.categoryId == selectedCategory.id : null;
    });

    return _react2.default.createElement('section', { className: 'grid-4' }, _react2.default.createElement('h1', null, ' ', componentTitle, ' '), hasSelectedCategory ? _react2.default.createElement('div', null, _react2.default.createElement(_selectedCategory2.default, { selected: selectedCategory, categories: categories }), _react2.default.createElement(_subCategoryAddForm2.default, this.props), _react2.default.createElement('ul', { className: 'list list--categories' }, filteredSubCategories.length ? filteredSubCategories.map(this.renderSubCategories) : this.noSubCategories())) : this.noCategorySelectedHtml());
  }
});

},{"./selected-category":6,"./sub-category-add-form":7,"react":166}],9:[function(require,module,exports){
...
},{"./ReactNoopUpdateQueue":79,"./canDefineProperty":114,"_process":9,"fbjs/lib/emptyObject":147,"fbjs/lib/invariant":154,"fbjs/lib/warning":165}]